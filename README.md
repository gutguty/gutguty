...
Пишу код на TypeScript, React, Python и Java  
...
|--------|----------|------|
| [**Interactive Debugger**](https://github.com/gutguty/interactive-debugger) | Fullstack веб-приложение для пошаговой визуализации и отладки алгоритмов на Python. Трейсер кода через AST-инструментирование, визуализация структур данных в реальном времени, система тестирования с автопроверкой решений и админ-панель | React, FastAPI, PostgreSQL, SQLAlchemy, Monaco Editor |
| [**ShoesShop**](https://github.com/gutguty/shoesShop) | Интернет-магазин кроссовок с корзиной на localStorage и динамической отрисовкой товаров через REST API | JavaScript, REST API, OOP, LocalStorage |
| [**Stream-Web-Site**](https://github.com/gutguty/Stream-Web-Site) | Frontend стримингового сервиса на фреймворке Minista с компонентной архитектурой | Minista, JSX, Vite |
